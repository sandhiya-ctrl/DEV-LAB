...
dataset.columns = ['Passengers']  # Rename column
...
# Step 5: Decomposition (Trend + Seasonality + Residual)
...
heatmap_data = dataset.pivot_table(values='Passengers', index='Month', columns='Year')
